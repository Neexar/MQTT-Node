...
// MQTTSend.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMQTTSendApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CMQTTSendApp

CMQTTSendApp::CMQTTSendApp()
{
...
// Единственный объект CMQTTSendApp

CMQTTSendApp theApp;


// инициализация CMQTTSendApp

BOOL CMQTTSendApp::InitInstance()
{
